...
public class StatementControllerIntegrationTest {
	...
	public void setup() {
		...
		this.mockMvc = MockMvcBuilders.webAppContextSetup(this.wac)
				.addFilter(filter, "/v1/xAPI/statements")
				.addFilter(xapiHeaderFilter, "/*")
				.addFilter(xapiRequestValidationFilter, "/v1/xAPI/*")
				.build();
	...
	public void thatStatementGetWithOAuthReturns200() throws Exception {
		String oauth = "OAuth realm=\"http://localhost/v1/xAPI/statements/\",oauth_consumer_key=\"openlrs\",oauth_signature_method=\"HMAC-SHA1\",oauth_timestamp=\"1466435259\",oauth_nonce=\"nTBDN7\",oauth_version=\"1.0\",oauth_signature=\"tu%2FTAAl5dt8grfo8QZ09AMv5PGk%3D\"";
		try {
      this.mockMvc.perform(
      		get("/v1/xAPI/statements/")
      			.header("Authorization", oauth)
	...
	public void shouldHandleStatementWithPrettyMuchEverything() throws Exception {
		String body = "{\"actor\": {\"name\": \"Team PB\",\"mbox\": \"mailto:teampb@example.com\",\"member\": ["+
